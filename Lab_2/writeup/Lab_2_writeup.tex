...
\newcommand{\hmwkTitle}{Lab 2} % Assignment title
\newcommand{\hmwkDueDate}{Monday, October 03, 2013} % Due date
...
\section{Specifications of the Selected DC Motor} \ \\
 
\section{Selecting a Load for the Motor} \ \\
...
%\begin{figure}[h!]
%\begin{center}
%\includegraphics[scale=0.07]{cone.png}
